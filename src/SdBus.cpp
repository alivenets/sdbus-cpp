...
int SdBus::sd_bus_set_bus_client(sd_bus *bus, int f)
{
    return ::sd_bus_set_bus_client(bus, f);
}

int SdBus::sd_bus_set_trusted(sd_bus *bus, int f)
{
    return ::sd_bus_set_trusted(bus, f);
}
